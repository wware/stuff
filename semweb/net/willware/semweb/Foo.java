...
public class Foo {
    ...
    private static final String airportName = "<http://www.daml.org/2001/10/html/airport-ont#name>";
    private static final String iataCode = "<http://www.daml.org/2001/10/html/airport-ont#iataCode>";
    //private static final String icaoCode = "<http://www.daml.org/2001/10/html/airport-ont#icaoCode>";
    private static final String nearestAirport = "<http://www.w3.org/2000/10/swap/pim/contact#nearestAirport>";

    //private static final String Parent = "<" + GenealogyModel.familyRdf + "/parent>";
    private static final String Father = "<" + GenealogyModel.familyRdf + "/father>";
    private static final String Mother = "<" + GenealogyModel.familyRdf + "/mother>";
    private static final String Son = "<" + GenealogyModel.familyRdf + "/son>";
    private static final String Daughter = "<" + GenealogyModel.familyRdf + "/daughter>";
    //private static final String Grandparent = "<" + GenealogyModel.familyRdf + "/grandparent>";
    private static final String Grandchild = "<" + GenealogyModel.familyRdf + "/grandchild>";
    ...
    public static void main(String[] _args) {
        ...
        model.query(query,
                new QueryProcessor() {
                    public void process(ResultBinding binding) {
                        System.out.println((Literal) binding.get("name1")
                                           + " knows "
        ...
        model.query(query, new QueryProcessor() {
            ...
            public void process(ResultBinding binding) {
                ...
                if (!alreadySeen.contains(combo)) {
                    System.out.println(name + " died on " + date);
        ...
        query.addTriplet("?airport", iataCode, "?code");
        ...
        model.query("SELECT ?eldername ?kidname\n"
                ...
                new QueryProcessor() {
                    public void process(ResultBinding binding) {
                        System.out.println((Literal) binding.get("kidname")
                                + " has father: "
        ...
        model.query("SELECT ?eldername ?kidname\n"
                ...
                new QueryProcessor() {
                    public void process(ResultBinding binding) {
                        System.out.println((Literal) binding.get("eldername")
                                + " has daughter: "
